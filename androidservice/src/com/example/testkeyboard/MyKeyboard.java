...
//键盘按键
	...
	public void onKey(int primaryCode, int[] keyCodes) {
		// TODO Auto-generated method stub
		Editable editable = this.getText();//Editable.getText()得到的是Editable类型，内容可变
	...
	private void initAttributes(Context context){
		...
		this.setImeOptions(EditorInfo.IME_FLAG_NO_EXTRACT_UI);//隐藏输入法中虚拟键盘的输入区域
		removeCopyAbility();
	...
	private void randomdigkey(Keyboard mKeyboard){
		...
		//通过随机数，从 LinkedList 中取出KeyModel放入新的 List中
		for (int i = 0; i < count; i++) {
